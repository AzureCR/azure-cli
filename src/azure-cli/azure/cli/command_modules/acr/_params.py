...
def load_arguments(self, _):  # pylint: disable=too-many-statements
    ...
    with self.argument_context('acr task') as c:
        ...
        c.argument('update_trigger_payload_type', help="Indicates whether to include metadata about the trigger in the payload alongwith the update trigger token, when a notification is sent.", arg_type=get_enum_type(UpdateTriggerPayloadType))
