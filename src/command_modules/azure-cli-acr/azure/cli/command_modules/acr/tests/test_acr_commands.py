...
class ACRTest(ResourceGroupVCRTestBase):
    ...
    def tear_down(self):
        self.cmd('storage account delete -n {} -g {}'.format(self.storage_account_1, self.resource_group))
        self.cmd('storage account delete -n {} -g {}'.format(self.storage_account_2, self.resource_group))
