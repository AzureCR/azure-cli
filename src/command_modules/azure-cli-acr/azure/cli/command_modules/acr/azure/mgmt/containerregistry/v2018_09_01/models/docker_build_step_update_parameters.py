...
class DockerBuildStepUpdateParameters(TaskStepUpdateParameters):
    ...
    def __init__(self, context_path=None, context_access_token=None, image_names=None, is_push_enabled=None, no_cache=None, docker_file_path=None, arguments=None):
