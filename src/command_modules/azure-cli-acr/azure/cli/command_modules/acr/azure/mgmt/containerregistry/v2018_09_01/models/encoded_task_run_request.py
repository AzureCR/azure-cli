...
class EncodedTaskRunRequest(RunRequest):
    ...
    def __init__(self, encoded_task_content, platform, is_archive_enabled=False, encoded_values_content=None, values=None, timeout=3600, agent_configuration=None, source_location=None):
