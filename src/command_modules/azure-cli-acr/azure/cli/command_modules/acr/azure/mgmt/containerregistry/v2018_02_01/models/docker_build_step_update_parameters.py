...
class DockerBuildStepUpdateParameters(BuildStepPropertiesUpdateParameters):
    ...
    def __init__(self, branch=None, image_names=None, is_push_enabled=None, no_cache=None, docker_file_path=None, context_path=None, build_arguments=None, base_image_trigger=None):
