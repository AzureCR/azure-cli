...
class FileTaskRunRequest(RunRequest):
    ...
    def __init__(self, task_file_path, platform, is_archive_enabled=False, values_file_path=None, values=None, timeout=3600, agent_configuration=None, source_location=None):
