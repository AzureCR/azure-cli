...
class Build(ProxyResource):
    ...
    :param status: The current status of the build. Possible values include:
     ...
     'Error', 'Timeout'
    :type status: str or
     ~azure.mgmt.containerregistry.v2018_02_01.models.BuildStatus
    ...
    :type build_type: str or
     ~azure.mgmt.containerregistry.v2018_02_01.models.BuildType
    ...
    :param output_images: The list of all images that were generated from the
     build.
    :type output_images:
     list[~azure.mgmt.containerregistry.v2018_02_01.models.ImageDescriptor]
    ...
    :type image_update_trigger:
     ~azure.mgmt.containerregistry.v2018_02_01.models.ImageUpdateTrigger
    :param git_commit_trigger: The git commit trigger that caused the build.
    :type git_commit_trigger:
     ~azure.mgmt.containerregistry.v2018_02_01.models.GitCommitTrigger
    ...
    :param platform: The platform properties against which the build will
     happen.
    :type platform:
     ~azure.mgmt.containerregistry.v2018_02_01.models.PlatformProperties
    ...
    :type provisioning_state: str or
     ~azure.mgmt.containerregistry.v2018_02_01.models.ProvisioningState
    """
    ...
    def __init__(self, build_id=None, status=None, last_updated_time=None, build_type=None, create_time=None, start_time=None, finish_time=None, output_images=None, build_task=None, image_update_trigger=None, git_commit_trigger=None, is_archive_enabled=False, platform=None, provisioning_state=None):
