...
class SourceRepositoryUpdateParameters(Model):
    ...
    :type source_control_auth_properties:
     ~azure.mgmt.containerregistry.v2018_02_01.models.SourceControlAuthInfo
    ...
    def __init__(self, source_control_auth_properties=None, is_commit_trigger_enabled=None):
