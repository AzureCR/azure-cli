...
class DockerBuildStep(BuildStepProperties):
    ...
    :type build_arguments:
     list[~azure.mgmt.containerregistry.v2018_02_01.models.BuildArgument]
    :ivar base_image_dependencies: List of base image dependencies for a step.
    :vartype base_image_dependencies:
     list[~azure.mgmt.containerregistry.v2018_02_01.models.BaseImageDependency]
    ...
    :type base_image_trigger: str or
     ~azure.mgmt.containerregistry.v2018_02_01.models.BaseImageTriggerType
    """
    ...
    def __init__(self, branch=None, image_names=None, is_push_enabled=True, no_cache=False, docker_file_path=None, context_path=None, build_arguments=None, base_image_trigger=None):
