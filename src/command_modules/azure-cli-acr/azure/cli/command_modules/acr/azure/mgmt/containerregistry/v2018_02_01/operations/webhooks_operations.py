...
class WebhooksOperations(object):
    ...
    def get(
        ...
        :rtype: ~azure.mgmt.containerregistry.v2018_02_01.models.Webhook or
    ...
    def create(
        ...
        :type webhook_create_parameters:
         ~azure.mgmt.containerregistry.v2018_02_01.models.WebhookCreateParameters
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: returns the direct response alongside the
         deserialized response
        ...
        :rtype:
         ~msrestazure.azure_operation.AzureOperationPoller[~azure.mgmt.containerregistry.v2018_02_01.models.Webhook]
    ...
    def update(
        ...
        :type webhook_update_parameters:
         ~azure.mgmt.containerregistry.v2018_02_01.models.WebhookUpdateParameters
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: returns the direct response alongside the
         deserialized response
        :return: An instance of AzureOperationPoller that returns Webhook or
    ...
    def list(
        ...
        :rtype:
         ~azure.mgmt.containerregistry.v2018_02_01.models.WebhookPaged[~azure.mgmt.containerregistry.v2018_02_01.models.Webhook]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
    ...
    def ping(
        ...
        :rtype: ~azure.mgmt.containerregistry.v2018_02_01.models.EventInfo or
         ~msrest.pipeline.ClientRawResponse
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
        # Construct URL
    ...
    def get_callback_config(
        ...
        :rtype:
         ~azure.mgmt.containerregistry.v2018_02_01.models.CallbackConfig or
         ~msrest.pipeline.ClientRawResponse
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
        # Construct URL
    ...
    def list_events(
        ...
        :rtype:
         ~azure.mgmt.containerregistry.v2018_02_01.models.EventPaged[~azure.mgmt.containerregistry.v2018_02_01.models.Event]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
        def internal_paging(next_link=None, raw=False):
