...
class DockerBuildRequest(RunRequest):
    ...
    def __init__(self, docker_file_path, platform, is_archive_enabled=False, image_names=None, is_push_enabled=True, no_cache=False, arguments=None, timeout=3600, agent_configuration=None, source_location=None):
