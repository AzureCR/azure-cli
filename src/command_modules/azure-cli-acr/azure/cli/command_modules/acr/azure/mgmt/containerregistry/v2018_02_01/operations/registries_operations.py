...
class RegistriesOperations(object):
    ...
    def check_name_availability(
        ...
        :rtype:
         ~azure.mgmt.containerregistry.v2018_02_01.models.RegistryNameStatus or
    ...
    def get(
        ...
        :rtype: ~azure.mgmt.containerregistry.v2018_02_01.models.Registry or
         ~msrest.pipeline.ClientRawResponse
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
        api_version = "2017-10-01"
    ...
    def create(
        ...
        :type registry:
         ~azure.mgmt.containerregistry.v2018_02_01.models.Registry
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: returns the direct response alongside the
         deserialized response
        ...
        :rtype:
         ~msrestazure.azure_operation.AzureOperationPoller[~azure.mgmt.containerregistry.v2018_02_01.models.Registry]
    ...
    def update(
        ...
        :type registry_update_parameters:
         ~azure.mgmt.containerregistry.v2018_02_01.models.RegistryUpdateParameters
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: returns the direct response alongside the
         deserialized response
        :return: An instance of AzureOperationPoller that returns Registry or
    ...
    def list_by_resource_group(
        ...
        :rtype:
         ~azure.mgmt.containerregistry.v2018_02_01.models.RegistryPaged[~azure.mgmt.containerregistry.v2018_02_01.models.Registry]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
        api_version = "2017-10-01"
    ...
    def list_credentials(
        ...
        :return: RegistryListCredentialsResult or ClientRawResponse if
         raw=true
        :rtype:
         ~azure.mgmt.containerregistry.v2018_02_01.models.RegistryListCredentialsResult
         or ~msrest.pipeline.ClientRawResponse
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
        api_version = "2017-10-01"
    ...
    def regenerate_credential(
        ...
        :param name: Specifies name of the password which should be
         ...
         'password', 'password2'
        :type name: str or
         ~azure.mgmt.containerregistry.v2018_02_01.models.PasswordName
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: returns the direct response alongside the
         deserialized response
        :param operation_config: :ref:`Operation configuration
    ...
    def list_usages(
        ...
        :rtype:
         ~azure.mgmt.containerregistry.v2018_02_01.models.RegistryUsageListResult
         or ~msrest.pipeline.ClientRawResponse
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
        api_version = "2017-10-01"
    ...
    def queue_build(
        ...
        :type build_request:
         ~azure.mgmt.containerregistry.v2018_02_01.models.QueueBuildRequest
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: returns the direct response alongside the
         deserialized response
        :return: An instance of AzureOperationPoller that returns Build or
         ClientRawResponse if raw=true
        :rtype:
         ~msrestazure.azure_operation.AzureOperationPoller[~azure.mgmt.containerregistry.v2018_02_01.models.Build]
         or ~msrest.pipeline.ClientRawResponse
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
    ...
    def get_build_source_upload_url(
        ...
        :rtype:
         ~azure.mgmt.containerregistry.v2018_02_01.models.SourceUploadDefinition
         or ~msrest.pipeline.ClientRawResponse
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
        api_version = "2018-02-01-preview"
