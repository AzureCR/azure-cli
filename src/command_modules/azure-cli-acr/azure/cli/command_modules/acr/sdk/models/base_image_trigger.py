...
class BaseImageTrigger(Model):
    ...
    :param include_trigger_metadata: Include Trigger metadata on Base image
     update triggers. Default value: True .
    ...
    def __init__(self, base_image_trigger_type, name, update_trigger_endpoint=None, include_trigger_metadata=True, status="Enabled"):
