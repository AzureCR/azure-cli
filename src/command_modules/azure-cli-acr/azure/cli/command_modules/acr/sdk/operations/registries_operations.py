...
class RegistriesOperations(object):
    ...
    def check_name_availability(
        ...
        :rtype: ~containerregistry.models.RegistryNameStatus or
    ...
    def get(
        ...
        :rtype: ~containerregistry.models.Registry or
         ~msrest.pipeline.ClientRawResponse
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
        api_version = "2017-10-01"
    ...
    def create(
        ...
        :type registry: ~containerregistry.models.Registry
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: returns the direct response alongside the
         deserialized response
        ...
        :rtype:
         ~msrestazure.azure_operation.AzureOperationPoller[~containerregistry.models.Registry]
    ...
    def list_by_resource_group(
        ...
        :rtype:
         ~containerregistry.models.RegistryPaged[~containerregistry.models.Registry]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
        api_version = "2017-10-01"
    ...
    def list_credentials(
        ...
        :return: RegistryListCredentialsResult or ClientRawResponse if
         raw=true
        :rtype: ~containerregistry.models.RegistryListCredentialsResult or
         ~msrest.pipeline.ClientRawResponse
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
        api_version = "2017-10-01"
    ...
    def list_usages(
        ...
        :rtype: ~containerregistry.models.RegistryUsageListResult or
         ~msrest.pipeline.ClientRawResponse
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
        api_version = "2017-10-01"
    ...
    def queue_build(
        ...
        :type build_request: ~containerregistry.models.QueueBuildRequest
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: returns the direct response alongside the
         deserialized response
    ...
    def get_build_source_upload_url(
        ...
        :rtype: ~containerregistry.models.SourceUploadDefinition or
         ~msrest.pipeline.ClientRawResponse
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
        api_version = "2018-02-01-preview"
